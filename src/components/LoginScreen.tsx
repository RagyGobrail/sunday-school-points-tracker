      ...
      <div className="max-w-md w-full bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-xl shadow-slate-200/50">
        ...
        <div className="space-y-4">
          <div className="bg-indigo-50/60 border border-indigo-100 rounded-2xl p-4 text-center">
            <p className="text-xs text-indigo-900 font-bold mb-2">
              طريقة تسجيل الدخول الرسمية والمعتمدة لقادة الفصل
            </p>
            <button
          ...
          <div className="relative flex py-1 items-center">
            ...
            <span className="shrink mx-4 text-xs text-slate-400 font-bold">أو استخدام البريد الإلكتروني</span>
            <div className="grow border-t border-slate-200"></div>
          </div>
            ...
            {mode === 'register' && (
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="مثال: الخادم مينا كمال"
                  value={displayName}
          ...
          <div className="text-center pt-2">
            ...
            >
              {mode === 'login'
                ? 'ليس لديك حساب؟ سجل حساب خادم جديد'
